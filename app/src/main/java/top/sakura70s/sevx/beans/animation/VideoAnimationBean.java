...
public class VideoAnimationBean implements Serializable {

    private Integer id;
    private Boolean seriesflag;
    private Integer seriesid;
    private String animation_name;
    private String animation_year;
    ...
    public String getAnimation_year() {
        return animation_year;
    }

    public void setAnimation_year(String animation_year) {
        this.animation_year = animation_year;
    }
